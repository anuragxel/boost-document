...
namespace boost { namespace doc { namespace libre_functions {
	...
	void export_libre(const boost::filesystem::path &inputPath, boost::document_file_format::type format);
	void close_libre(const boost::filesystem::path &inputPath,bool save);
